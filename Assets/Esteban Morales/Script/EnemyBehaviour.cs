...
public class EnemyBehaviour : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (EnemyType == 4){ health = 40;}// Boss enemy 
    ...
    void timerEnded()
    {
        ...
        if (EnemyType == 4) { targetTime = Random.Range(2f, 15.0f); }// Boss enemy 
    }
    public void EnemyShoot()
    {
        if (EnemyType != 3) // this is to avoid error on the shield enemy that does not shoot
        {
